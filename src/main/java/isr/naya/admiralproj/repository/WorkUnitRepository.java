...
public interface WorkUnitRepository extends JpaRepository<WorkUnit, Integer> {
    ...
    @Query("select new isr.naya.admiralproj.dto.WorkInfo(wu.id, wa.id, e.id, e.name, e.surname, e.email, e.employeeNumber, d.name, p.id, p.name, c.id, c.name, wu.date, wu.absenceType, wu.start, wu.finish, wu.duration, wu.comment) from WorkUnit wu join wu.workAgreement wa join wa.employee e join wa.project p join p.client c join e.department d where wu.date between ?1 and ?2 order by wu.date desc ")
    List<WorkInfo> getAllByDateBetween(LocalDate from, LocalDate to);

    @Query("select new isr.naya.admiralproj.dto.WorkInfo(wu.id, wa.id, e.id, e.name, e.surname, e.email, e.employeeNumber, d.name, p.id, p.name, c.id, c.name, wu.date, wu.absenceType, wu.start, wu.finish, wu.duration, wu.comment) from WorkUnit wu join wu.workAgreement wa join wa.employee e join wa.project p join p.client c join e.department d where e.id =?3 and wu.date between ?1 and ?2 order by wu.date desc ")
    List<WorkInfo> getAllByDateBetweenAndEmployeeId(LocalDate from, LocalDate to, Integer employeeId);

    @Query("select new isr.naya.admiralproj.dto.WorkInfo(wu.id, wa.id, e.id, e.name, e.surname, e.email, e.employeeNumber, d.name, p.id, p.name, c.id, c.name, wu.date, wu.absenceType, wu.start, wu.finish, wu.duration, wu.comment) from WorkUnit wu join wu.workAgreement wa join wa.employee e join wa.project p join p.client c join e.department d where d.id =?3 and wu.date between ?1 and ?2 order by wu.date desc ")
    List<WorkInfo> getAllByDateBetweenAndDepartmentId(LocalDate from, LocalDate to, Integer departmentId);

    @Query("select new isr.naya.admiralproj.dto.WorkInfo(wu.id, wa.id, e.id, e.name, e.surname, e.email, e.employeeNumber, d.name, p.id, p.name, c.id, c.name, wu.date, wu.absenceType, wu.start, wu.finish, wu.duration, wu.comment) from WorkUnit wu join wu.workAgreement wa join wa.employee e join wa.project p join p.client c join e.department d where p.id =?3 and wu.date between ?1 and ?2 order by wu.date desc ")
    List<WorkInfo> getAllByDateBetweenAndProjectId(LocalDate from, LocalDate to, Integer projectId);

    @Query("select new isr.naya.admiralproj.dto.WorkInfo(wu.id, wa.id, e.id, e.name, e.surname, e.email, e.employeeNumber, d.name, p.id, p.name, c.id, c.name, wu.date, wu.absenceType, wu.start, wu.finish, wu.duration, wu.comment) from WorkUnit wu join wu.workAgreement wa join wa.employee e join wa.project p join p.client c join e.department d where c.id =?3 and wu.date between ?1 and ?2 order by wu.date desc ")
    List<WorkInfo> getAllByDateBetweenAndClientId(LocalDate from, LocalDate to, Integer clientId);

    @Query("select new isr.naya.admiralproj.dto.WorkInfo(wu.id, wa.id, e.id, e.name, e.surname, e.email, e.employeeNumber, d.name, p.id, p.name, c.id, c.name, wu.date, wu.absenceType, wu.start, wu.finish, wu.duration, wu.comment) from WorkUnit wu join wu.workAgreement wa join wa.employee e join wa.project p join p.client c join e.department d where e.id =?3 and c.id=?4 and wu.date between ?1 and ?2 order by wu.date desc ")
    ...
    @Query("select new isr.naya.admiralproj.dto.WorkInfo(wu.id, wa.id, e.id, e.name, e.surname, e.email, e.employeeNumber, d.name, p.id, p.name, c.id, c.name, wu.date, wu.absenceType, wu.start, wu.finish, wu.duration, wu.comment) from WorkUnit wu join wu.workAgreement wa join wa.employee e join wa.project p join p.client c join e.department d where d.id =?3 and p.id=?4 and wu.date between ?1 and ?2 order by wu.date desc ")
    ...
    @Query("select new isr.naya.admiralproj.dto.WorkInfo(wu.id, wa.id, e.id, e.name, e.surname, e.email, e.employeeNumber, d.name, p.id, p.name, c.id, c.name, wu.date, wu.absenceType, wu.start, wu.finish, wu.duration, wu.comment) from WorkUnit wu join wu.workAgreement wa join wa.employee e join wa.project p join p.client c join e.department d where d.id =?3 and c.id=?4 and wu.date between ?1 and ?2 order by wu.date desc ")
    ...
    @Query("select new isr.naya.admiralproj.dto.WorkInfo(wu.id, wa.id, e.id, e.name, e.surname, e.email, e.employeeNumber, d.name, p.id, p.name, c.id, c.name, wu.date, wu.absenceType, wu.start, wu.finish, wu.duration, wu.comment) from WorkUnit wu join wu.workAgreement wa join wa.employee e join wa.project p join p.client c join e.department d where e.id =?3 and p.id=?4 and wu.date between ?1 and ?2 order by wu.date desc ")
