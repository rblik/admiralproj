...
public class WorkInfo implements Serializable {
    ...
    public WorkInfo(Integer unitId, Integer agreementId, Integer employeeId, String employeeName, String employeeSurname, String employeeEmail, String employeeNumber, String departmentName, Integer projectId, String projectName, Integer clientId, String clientName, LocalDate date, LocalTime from, LocalTime to, Long duration, String comment) {
        this(unitId, agreementId, employeeId, employeeName, employeeSurname, employeeEmail, employeeNumber, departmentName, projectId, projectName, clientId, clientName, null, date, from, to, duration, comment, null, null, null, null);
    }

    public WorkInfo(Integer unitId, Integer agreementId, Integer employeeId, String employeeName, String employeeSurname, String employeeEmail, String employeeNumber, String departmentName, Integer projectId, String projectName, Integer clientId, String clientName, LocalDate date, LocalTime from, LocalTime to, Long duration, String comment, Boolean isActiveAgreement) {
        this(unitId, agreementId, employeeId, employeeName, employeeSurname, employeeEmail, employeeNumber, departmentName, projectId, projectName, clientId, clientName, null, date, from, to, duration, comment, null, null, null, isActiveAgreement);
    }
    ...
    public WorkInfo(Integer agreementId, LocalDate date, String clientName, Long duration, String clientColor) {
        this(null, agreementId, null, null, null, null, null, null, null, null, null, clientName, null, date, null, null, duration, null, null, null, null, null, clientColor);
    }
    ...
    public WorkInfo(Integer employeeId, String employeeName, String employeeSurname, String employeeNumber, String departmentName, Integer projectId, String projectName, String clientName, String clientNumber, Long duration, Double amount, Currency currency, TariffType type) {
        this(null, null, employeeId, employeeName, employeeSurname, null, employeeNumber, departmentName, projectId, projectName, null, clientName, clientNumber, null, null, null, duration, null, amount, currency, type, null);
    }

    public WorkInfo(Integer unitId, Integer agreementId, Integer employeeId, String employeeName, String employeeSurname, String employeeEmail, String employeeNumber, String departmentName, Integer projectId, String projectName, Integer clientId, String clientName, String clientNumber, LocalDate date, LocalTime from, LocalTime to, Long duration, String comment, Double amount, Currency currency, TariffType type, Boolean isActiveAgreement) {
        this(unitId, agreementId, employeeId, employeeName, employeeSurname, employeeEmail, employeeNumber, departmentName, projectId, projectName, clientId, clientName, clientNumber, date, from, to, duration, comment, amount, currency, type, isActiveAgreement, null);
    }
}
