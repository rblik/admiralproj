...
public class WorkInfo {
    ...
    public WorkInfo(Integer employeeId, String employeeName, String employeeSurname, LocalDate date, Long duration) {
        this(null, employeeId, employeeName, employeeSurname, null, null, null, null, null, date, null, null, duration, null);
    }

    public WorkInfo(Integer employeeId, LocalDate date) {
        this(null, employeeId, null, null, null, null, null, null, null, date, null, null, null, null);
    }

    public WorkInfo(Integer agreementId, LocalDate date, LocalTime from, LocalTime to, Long duration, String comment) {
        this(agreementId, null, null, null, null, null, null, null, null, date, from, to, duration, comment);
    }

    public WorkInfo(Integer employeeId, String employeeName, String employeeSurname, String departmentName, LocalDate date) {
        this(null, employeeId, employeeName, employeeSurname, departmentName, null, null, null, null, date, null, null, null, null);
    }
    ...
    public WorkInfo(Integer agreementId, Integer employeeId, String employeeName, String employeeSurname, String departmentName, Integer projectId, String projectName, Integer clientId, String clientName, LocalDate date) {
        this(agreementId, employeeId, employeeName, employeeSurname, departmentName, projectId, projectName, clientId, clientName, date, null, null, null, null);
    }
}
